...
class SmartTextProcessor:
    ...
    def format_raw_text(self, content: str) -> str:
        """Format raw text into a more readable structure"""
        ...
        with tab3:
            ...
            with col1:
                ...
                <head>
                    ...
                    .formatted-text {{ {st.markdown.get_option('unsafe_allow_html')} }}
            ...
            with col2:
                ...
                st.download_button(
                    label="📝 Download Text",
                    data=st.session_state.raw_input,
                    file_name=f"original_text_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt",
                    mime="text/plain",
                    use_container_width=True
                )
