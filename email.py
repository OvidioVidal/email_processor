...
Intelligence ID: intelcms-k9mrqp"""
    ...
    with col2:
        ...
        if 'formatted_text' in st.session_state:
            ...
            with tab2:
                ...
                st.info("💡 This format matches your preferred email structure - clean and simple with proper spacing.")
    ...
    if 'formatted_text' in st.session_state:
        ...
        with tab2:
            ...
            st.text_area("Professional Summary:", summary, height=400, key="summary_text_area")
